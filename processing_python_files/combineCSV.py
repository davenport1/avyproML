...
directory = "C:/Users/daven/Documents/avydatacleaning/NOAAdata/season2018"
...
#%%
newcsv = pd.DataFrame(d, index=pd.date_range(start='11/21/2018', end='04/21/2019'))
print(newcsv.shape)
...
newcsv.to_csv("x_data_2018-2019_totals", index=False)
